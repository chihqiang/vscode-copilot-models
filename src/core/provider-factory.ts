...
export interface GenericProviderOptions<
  TClient extends IApiClient = IApiClient,
> {
  /** Provider ID */
  providerId: string;
...
export interface GenericProviderFactoryResult {
  ...
  register: () => void;
  /** Chat Provider class */
  GenericChatProvider: new (
    context: vscode.ExtensionContext,
  ) => BaseChatProvider;
  /** Model Provider class */
  GenericModelProvider: new (
    context: vscode.ExtensionContext,
  ) => BaseModelProvider;
}
 ...
 * }
 */
export function createGenericProviderFactory(
  options: GenericProviderOptions,
): GenericProviderFactoryResult {
